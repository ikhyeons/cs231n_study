...
class KNN:
    def __init__(self, dataset):
        ...
        self.trainX = np.array(self.X[:45000])
        self.trainY = np.array(self.Y[:45000])
...
knn = KNN(make_classification(n_samples=50000, n_features=15, n_informative=5, n_classes=10, random_state=40))

for i in range(len(knn.testX)):
    knn.run(50, i);

print("%s %%" % (knn.success / 5000 * 100))
